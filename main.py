...
def main(hyper: HyperPc) -> None:
    ...
    match user_input:
        case 1:
            ...
            print("The result is saved in Catalog.json")
        case 2:
            hyper.parse_optimal_pc()
            print("The result is saved in Optimal.json")
        case 3:
            hyper.parse_powerful_pc()
            print("The result is saved in Powerful.json")
        case 4:
            hyper.parse_custom_pc()
            print("The result is saved in Custom.json")
        case 5:
